      ...
      <div className="grid md:grid-cols-3 gap-4 md:gap-6 mb-8">
        <div className="bg-card border border-border rounded-2xl p-6">
          ...
          <p className="text-muted-foreground leading-relaxed text-base">
            Otoczenie to zabudowa jednorodzinna.<br />Projekt planu ogólnego przewiduje zabudowę o intensywności <span className="font-bold">1.6</span>, podczas gdy w okolicy wskaźnik ten wynosi <span className="font-bold">0.9</span>.
          </p>
        </div>
