  ...
  return (
    <div className="max-w-5xl mx-auto mb-10">
      ...
      <div className="grid md:grid-cols-3 gap-4 md:gap-6 mb-8">
        <div className="group bg-card border border-border rounded-2xl p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
          <div className="text-center md:text-left">
            <div className="flex items-center justify-center md:justify-start gap-1 mb-1">
              ...
              <span className="text-3xl md:text-4xl font-bold text-foreground">~1000 mieszkań</span>
            </div>
          ...
          <div className="text-center md:text-left border-l border-border pl-4 md:pl-6">
            ...
            <p className="text-xs md:text-sm text-muted-foreground leading-tight">
              może dodatkowo powstać na działce miejskiej między ul. Ukośną a Olkuską
            </p>
          </div>
        </div>
        ...
        <div className="mt-6 pt-6 border-t border-border">
          <div className="text-center md:text-left">
            <div className="flex items-center justify-center md:justify-start gap-1 mb-1">
              ...
              <span className="text-3xl md:text-4xl font-bold text-slate-800">i <span className="text-destructive">2000</span> dodatkowych samochodów?</span>
            </div>
            <p className="text-xs md:text-sm text-muted-foreground leading-tight">
