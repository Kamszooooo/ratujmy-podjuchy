...
const HeroSection = () => {
  return (
    <section className="relative <section className="relative min-h-[22vh] flex items-center justify-center overflow-hidden" style={{ background: "var(--hero-gradient)" }}> flex items-center justify-center overflow-hidden" style={{ background: "var(--hero-gradient)" }}>
      {/* Decorative elements */}
