...
const items = [
  ...
  },
  {
    ...
    body: (
      <>
        Działamy dalej przeciwko budowie blokowiska TBS na górkach w Podjuchach. <strong className="font-semibold text-foreground">W dalszym ciągu opowiadamy się za zabudową jednorodzinną oraz strefą zieleni.</strong> Wkrótce poinformujemy o naszych kolejnych inicjatywach.
      </>
    ),
  },
  {
